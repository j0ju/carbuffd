...
func CreateTcpCarbonReceiver(laddr string, ch chan string) *TcpCarbonReceiver {
	var err error
	l := new(TcpCarbonReceiver)
...
func (l *TcpCarbonReceiver) clientHandler(c net.Conn) {
...
func (l *TcpCarbonReceiver) metricFilter(m string) (string, bool) {
